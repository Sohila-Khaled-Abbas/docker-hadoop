...
powershell -ExecutionPolicy Bypass -File "%~dp0..\..\scripts\vmware\optimize-kali-vmx.ps1"
if %errorlevel% neq 0 (
...
set "VMX_FILE=%~dp0..\..\kali-linux-2026.2-vmware-amd64.vmwarevm\kali-linux-2026.2-vmware-amd64.vmx"
