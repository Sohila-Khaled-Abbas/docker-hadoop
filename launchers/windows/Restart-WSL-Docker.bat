@echo off
chcp 65001 >nul
title Unfreeze WSL2 and Restart Docker Desktop
cd /d "%~dp0..\..\"

echo =================================================================
echo   WSL2 and Docker Desktop Engine Recovery Utility
echo =================================================================
echo.
...
net session >nul 2>&1
if %errorLevel% neq 0 (
    echo [INFO] Requesting Administrator privileges to restart WSL Service...
